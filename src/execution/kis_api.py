...
class KISApi:
    ...
    def get_orders(self) -> list[dict[str, Any]]:
        ...
        tr_id = "VTTC8001R" if self.auth.is_paper else "TTTC8001R"
        headers = self._get_headers(tr_id)
    ...
    def cancel_order(self, order_no: str, stock_code: str, quantity: int) -> dict[str, Any]:
        """
        주문 취소.
        ...
        tr_id = "VTTC0803U" if self.auth.is_paper else "TTTC0803U"
        headers = self._get_headers(tr_id)
